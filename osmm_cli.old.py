...
@click.option('--watch-list',  '-wl', "wlist", is_flag=True, type=bool, help="Silent watch- of assets (updates local cache)")
@click.option('--watch-clear', '-wc', "wclear", is_flag=True, type=bool, help="Silent feed of assets (updates local cache)")
@click.option('--watch-add',   '-wa', "wadd", type=str, default=None, help="Silent feed of assets (updates local cache)")
@click.option('--watch-del',   '-wd', "wdel", type=str, default=None, help="Silent feed of assets (updates local cache)")
